...
struct buttonsView: View {
    ...
    private var dyslexiaFontScale: CGFloat {
        settings.selectedFont.contains("OpenDyslexic") ? 0.9 : 1.0
    }
                        ...
                        HStack {
                            VStack(alignment: .leading, spacing: 8) {
                                Image(systemName: "camera")
                                    .font(.system(size: settings.textSize * 4.375 * dyslexiaFontScale))
                                    .foregroundColor(settings.accentColor)
                                Text("Scan your text")
                                    .font(settings.customFont(size: settings.textSize * 1.5 * dyslexiaFontScale, weight: .bold))
                                    .foregroundColor(.primary)
                                    .lineLimit(1)
                                    .minimumScaleFactor(0.9)
                                Text("Open the camera, select a photo or a file...and let Leggy help you")
                                    .font(settings.customFont(size: settings.textSize * 0.875 * dyslexiaFontScale, weight: settings.boldText ? .bold : .regular))
